class Slider {
    ...
    initPoint() {
        ...
        this.indexBox.children[0].addEventListener("click", (e) => {
            console.log("point")
            let pointIndex = (e.target).getAttribute("data-info")
    ...
    move(offset) {
        ...
        console.log(this.indexBox.children[0].children[this.index - 1])
